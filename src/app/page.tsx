  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="blob w-[46rem] h-[46rem] bg-[#1877F2]/20 -top-56 left-1/4" />
        <div className="blob w-[34rem] h-[34rem] bg-purple-600/12 top-1/3 -right-40" style={{ animationDelay: "-8s" }} />
        <div className="blob w-[28rem] h-[28rem] bg-emerald-500/8 bottom-0 -left-32" style={{ animationDelay: "-14s" }} />
        <div
      ...
      {/* ── Nav ── */}
      <header className="relative border-b border-white/5 bg-slate-950/70 backdrop-blur-xl sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl overflow-hidden border border-white/10 shadow-lg shadow-[#1877F2]/25">
            ...
            <div>
              ...
              <p className="text-[9px] uppercase tracking-[0.2em] text-[#8ab9f9] font-bold leading-tight">Verification Panel</p>
            </div>
          </div>
      ...
      <main className="relative">
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-14 lg:pt-24 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#1877F2]/30 bg-[#1877F2]/10 px-3.5 py-1.5 mb-6">
              <span className="relative inline-block w-1.5 h-1.5 rounded-full bg-emerald-400 text-emerald-400 live-ping" />
              <span className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#8ab9f9]">Live stock · updated in real time</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold text-white leading-[1.08] tracking-tight">
              ...
              <span className="bg-gradient-to-r from-[#8ab9f9] via-[#1877F2] to-[#8ab9f9] bg-clip-text text-transparent">
                delivered in seconds
              </span>
            </h1>
            <p className="text-slate-400 text-base sm:text-lg mt-5 max-w-xl leading-relaxed">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-3 mt-10">
              {[
                ...
                <div key={s.l}>
                  ...
                  <p className="text-[11px] uppercase tracking-widest text-slate-500 font-bold mt-0.5">{s.l}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative mx-auto w-full max-w-md">
            <div className="absolute -inset-6 bg-[#1877F2]/15 blur-3xl rounded-full" aria-hidden="true" />
            <div className="relative rounded-3xl border border-[#1877F2]/30 bg-slate-900/90 backdrop-blur-xl shadow-2xl fb-glow p-5 sm:p-6">
              <div className="absolute inset-y-0 left-0 w-1.5 fb-gradient rounded-l-3xl" aria-hidden="true" />
              <div className="flex items-start justify-between gap-3 mb-4 pl-2">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold">Facebook verification</p>
                  </div>
                </div>
              ...
              <p className="pl-2 text-slate-200 font-mono text-lg">+92 300 1234567</p>
              <div className="mt-3 rounded-2xl bg-slate-950/70 border border-white/5 p-4 text-center">
                <p className="text-[10px] text-slate-500 mb-2 uppercase tracking-[0.2em] font-bold">Facebook OTP / SMS code</p>
              ...
              <div className="mt-4 pl-2">
                <div className="flex items-center justify-between text-[11px] mb-1.5">
                  ...
                  <span className="font-mono font-bold text-slate-300 tabular-nums">18:42</span>
                </div>
                <div className="h-1.5 w-full rounded-full bg-white/5 overflow-hidden">
                  <div className="h-full rounded-full fb-gradient" style={{ width: "72%" }} />
                </div>
              </div>
            ...
            {/* floating mini card */}
            <div className="hidden sm:block absolute -bottom-6 -left-8 rounded-2xl border border-white/10 bg-slate-900/95 backdrop-blur-xl shadow-xl px-4 py-3 animate-fade-in">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500">Know the moment it lands</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#8ab9f9] mb-2">Why SMSFlow</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={f.t} className="group bg-slate-900/70 border border-white/10 rounded-2xl p-5 card-hover hover:border-[#1877F2]/40 transition-colors">
                <span className="grid place-items-center w-11 h-11 rounded-xl bg-[#1877F2]/10 border border-[#1877F2]/25 text-lg mb-4 group-hover:scale-110 transition-transform">
                  {f.icon}
                </span>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#8ab9f9] mb-2">3 simple steps</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative">
            {[
              ...
              <div key={s.n} className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-slate-900/90 to-slate-900/50 p-6 card-hover">
                <span className="grid place-items-center w-10 h-10 rounded-xl fb-gradient text-white text-sm font-bold shadow-lg shadow-[#1877F2]/25 mb-4">
                  {s.n}
                </span>
        ...
        {/* ── CTA ── */}
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
          <div className="relative overflow-hidden rounded-3xl border border-[#1877F2]/30 bg-gradient-to-br from-[#1877F2]/20 via-slate-900/70 to-slate-900/40 p-8 sm:p-12 text-center">
            <div className="absolute -right-16 -top-24 h-72 w-72 rounded-full bg-[#1877F2]/25 blur-3xl" aria-hidden="true" />
            <div className="absolute -left-16 -bottom-24 h-72 w-72 rounded-full bg-purple-600/15 blur-3xl" aria-hidden="true" />
            <div className="relative">
              <div className="inline-flex items-center justify-center mb-5 fb-badge-bloom">
      ...
      <footer className="relative border-t border-white/5 mt-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-slate-600">© {new Date().getFullYear()} SMSFlow · All rights reserved</p>
        </div>
      </footer>
    </div>
  );
